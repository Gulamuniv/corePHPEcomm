...
.payment a{width:100px;margin: 5px auto 0;padding: 7px 0; text-align: center;display: block;background: #23cc1d;border: 1px solid #333;color: #fff;border-radius: 3px;font-size: 20px; }
</style>
