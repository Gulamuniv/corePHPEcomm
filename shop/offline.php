...
.tblone{width: 500px; margin: 0 auto; border: 2px solid #ddd; font-size: 13px;} 
 ...
 .ordernow{}
 .ordernow a{width:150px;margin: 5px auto 0;padding: 7px 0; text-align: center;display: block;background: #1dcc89;border: 1px solid #333;color: #fff;border-radius: 3px;font-size: 25px; margin-bottom: 40px;}
